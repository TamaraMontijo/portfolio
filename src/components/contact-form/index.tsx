    ...
    >
      <div className="w-full max-w-[420px] mx-auto">
        ...
        >
          <input
            placeholder="Name"
            className="w-full h-14 bg-gray-800 rounded-lg placeholder:text-gray-400 text-gray-500 p-4 focus:outline-none focus:ring-2 ring-gray-600"
            {...register('name')}
          />
          <input
            placeholder="E-mail"
          ...
          <textarea
            placeholder="Message"
            maxLength={500}
            className="resize-none w-full h-[138px] bg-gray-800 rounded-lg placeholder:text-gray-400 text-gray-500 p-4 focus:outline-none focus:ring-2 ring-gray-600"
            {...register('message')}
          />
